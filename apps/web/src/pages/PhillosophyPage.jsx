<div className="page-container">
  <h1 className="page-title">Studio Philosophy</h1>
  ...
  <div className="philosophy-grid">
    ...
    <div className="philosophy-card">
      <h2>Player Respect</h2>

      <p>
        Games should remain accessible to players.
        Project Neverphorm strongly values fair pricing,
        meaningful content, and avoiding practices
        that take advantage of players financially.
      </p>
    </div>
